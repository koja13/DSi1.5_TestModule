...
<div id='mainQuizDiv'>
 ...
 <!--  	<form action="">-->
      ...
      <div id="q1" class="question">
      	...
      	<p class="answer"><input class="radio" type="radio" name="q1" value=""> Odgovor 1</p>
      	<p class="answer"><input class="radio" type="radio" name="q1" value=""> Odgovor 2</p>
      	<p class="answer"><input class="radio" type="radio" name="q1" value=""> Odgovor 3</p>
      ...
      <div id="q2" class="question">
	    ...
	    <p id="question2" class ="qPar">Ovo je pitanje broj 2? </p> <br />
      	...
      	<p class="answer"><input class="radio" type="radio" name="q2" value=""> Odgovor 1</p>
      	<p class="answer"><input class="radio" type="radio" name="q2" value=""> Odgovor 2</p>
      	<p class="answer"><input class="radio" type="radio" name="q2" value=""> Odgovor 3</p>
      </div><br />
      ...
      <div id="q3" class="question" >
      	...
      	<p class="answer"><input class="radio" type="radio" name="q3" value=""> Odgovor 1</p>
      	<p class="answer"><input class="radio" type="radio" name="q3" value=""> Odgovor 2</p>
      	<p class="answer"><input class="radio" type="radio" name="q3" value=""> Odgovor 3</p>
      </div>
